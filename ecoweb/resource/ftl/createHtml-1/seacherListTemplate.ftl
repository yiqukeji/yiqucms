...
<div class="content">
    ...
    <input name="type" type="hidden" class="type" value=""/>
    <input name="htmlStr" class="htmlStr" type="hidden" value="webdetail.html"/>
        <div class="cont-menu">
        ...
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;<span class="name">搜索内容</span></p>
            </div>
            <div class="list">
...
<script src="fh_static_1/js/seacheSetDate.js"></script>
</body>
</html>