...
<div class="content">
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <div class="cont-menu-title1"><a href="webc.html" class="active">财税系</a></div>
        ...
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="./index.html">首页</a>&nbsp;>&nbsp;<span class="eo10">师资队伍</span>  >财税系</p>
            </div>
            <div class="teach-div">
                ...
                <div class="teach-content">
                    <ul>
                        <#list fieldListeo33 as var>
                        <#if var[8]?trim=="教授">
                        <li><a href="JavaScript:;" title="${var[1]}" onclick="gotoDetail('webdetail.html','eo33','eo33','${var[0]}')">${var[1]}</a></li>
                        </#if>
                        </#list>
                    </ul>
                </div>
