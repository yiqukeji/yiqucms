    ...
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                ...
                <li   class="ons"><a href="webghzs_d.html">工会之声</a></li>
                <li><a href="webllxx_d.html">理论学习</a></li>
            </ul>
        </div>
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp; 党建工作&nbsp;>&nbsp;工会之声</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPageghzs_d},
        totalSize: ${totalResultghzs_d},
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'ghzs_d',currentPage:num},
            dataType: "json",
