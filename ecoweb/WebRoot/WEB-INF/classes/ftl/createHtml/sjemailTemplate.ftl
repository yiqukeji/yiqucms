...
<div class="content">
    <div class="center-1200">
        ...
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>>书记信箱</p>
            </div>
            <div class="email">
                <div class="email-title">书记信箱</div>
                <div class="form-div">
                <form action="web/savaMessage.do" method="post">
                        <input value="sj" hidden="hidden" name="TYPE" id="TYPE"/>
                        ...
                        <div><label>Q&nbsp&nbspQ :</label><input type="text" name="QQ" id="QQ" placeholder="请输入您的扣扣"></div>
                        <div><label>邮 箱 :</label><input type="text" name="EMAIL" id="EMAIL" placeholder="请输入您的邮箱" required></div>
                        <div><label>意 见 :</label><textarea name="CONTEXT" id="CONTEXT" placeholder="请输入你的意见..." required></textarea></div>
