    ...
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                ...
                <li><a href="webdjgz_s.html">党建中心</a></li>
                <li><a href="webxsgz_s.html">学会工作</a></li>
                <li><a href="webtwgz_s.html">团委工作</a></li>
            </ul>
        </div>
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;学生思政&nbsp;>&nbsp;最新消息</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagesz},
        totalSize: ${totalResultsz},
        callback: function (num) {
            ajaxTest(${currentPagesz});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'sz',currentPage:num},
            dataType: "json",
