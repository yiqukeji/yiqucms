    ...
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                ...
                <li class="ons"><a href="webplan_y.html">培养方案</a></li>
        ...
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;研究生教育&nbsp;>&nbsp;培养方案</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagepyfa_y},
        totalSize: ${totalResultpyfa_y},
        callback: function (num) {
            ajaxTest(${currentPagepyfa_y});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'pyfa_y',currentPage:num},
            dataType: "json",
