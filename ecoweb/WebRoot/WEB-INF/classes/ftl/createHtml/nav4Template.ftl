...
<div class="content">
    <div class="center-1200">
        ...
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;研究生学术论坛</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPageyjsxslt},
        totalSize: ${totalResultyjsxslt},
        callback: function (num) {
            ajaxTest(${currentPageyjsxslt});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'yjsxslt',currentPage:num},
            dataType: "json",
