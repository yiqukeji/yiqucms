...
<div class="content">
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                <li><a href="webzxxx_s.html">最新消息</a></li>
                <li class="ons"><a href="webxsgz_s.html">学生工作</a></li>
                <li><a href="webtwgz_s.html">团委工作</a></li>
                <li><a href="webdjgz_s.html">学生社团</a></li>
            </ul>
        </div>
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp; 学生工作&nbsp;>&nbsp;学生工作</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagexsgz_s},
        totalSize: ${totalResultxsgz_s},
        callback: function (num) {
            ajaxTest(${currentPagexsgz_s});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'xsgz_s',currentPage:num},
            dataType: "json",
