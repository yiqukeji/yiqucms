...
<div class="content">
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
               <li ><a href="webzxxx_k.html">最新消息</a></li>
                <li ><a href="webxkjs.html">学科建设</a></li>
                <li class="ons"><a href="webkydt.html">科研动态</a></li>
            </ul>
        </div>
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>>科研动态 > 科研动态</p>
            </div>
            <div class="list">
                <ul class="list-ul">
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPageky},
        totalSize: ${totalResultky},
        callback: function (num) {
            ajaxTest(${currentPageky});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'ky',currentPage:num},
            dataType: "json",
