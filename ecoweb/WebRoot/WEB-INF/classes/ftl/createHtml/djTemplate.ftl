...
<div class="content">
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                <li class="ons"><a href="webzxxx_d.html">最新消息</a></li>
        ...
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;学院党政&nbsp;>&nbsp;最新消息</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagedj},
        totalSize: ${totalResultdj},
        callback: function (num) {
            ajaxTest(${currentPagedj});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'dj',currentPage:num},
            dataType: "json",
