...
<div class="content">
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                <li class="ons"><a href="webzxxx.html">最新消息</a></li>
        ...
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;对外交流&nbsp;>&nbsp;最新消息</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagezxxx},
        totalSize: ${totalResultzxxx},
        callback: function (num) {
            ajaxTest(${currentPagezxxx});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'zxxx',currentPage:num},
            dataType: "json",
