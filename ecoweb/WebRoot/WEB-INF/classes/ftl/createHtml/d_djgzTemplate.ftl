    ...
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                ...
                <li class="ons"><a href="webdjgz_d.html">党建中心</a></li>
        ...
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp; 党建工作&nbsp;>&nbsp;党建中心</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagedjgz},
        totalSize: ${totalResultdjgz},
        callback: function (num) {
            ajaxTest(${currentPagedjgz});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'djgz',currentPage:num},
            dataType: "json",
