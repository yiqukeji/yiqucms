...
<div class="content">
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                <li><a href="webprof_y.html">专业介绍</a></li>
                <li><a href="webplan_y.html">培养方案</a></li>
                <li class="ons"><a href="webregu_y.html">规章制度</a></li>
            </ul>
        </div>
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;研究生教育&nbsp;>&nbsp;规章制度</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagegzzd_y},
        totalSize: ${totalResultgzzd_y},
        callback: function (num) {
            ajaxTest(${currentPagegzzd_y});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'gzzd_y',currentPage:num},
            dataType: "json",
