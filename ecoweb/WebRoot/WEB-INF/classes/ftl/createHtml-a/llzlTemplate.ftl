...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos"><!-- 当前位置 -->
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;>&nbsp;<a href="#">理论专栏</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=llxx" method="post" name="Form" id="Form">
		<div class="tabBox"><!-- 选项卡 -->
			<ul class="conBox">	
				<li class="content content1">
					<ul class="box commC">
					    <#list fieldListllxx as var>
					...
					<a href="javascript:;"  onclick='nextPage(${totalPagellxx})'>尾页</a>
					<#elseif (totalPagellxx=1)> 
