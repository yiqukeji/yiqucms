...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos">
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="./shsj.html">社会实践</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=shsj" method="post" name="Form" id="Form">
		<div class="list_box">	
				<ul class="commC">
				    <#list fieldListshsj as var>
				...
				<a href="javascript:;"  onclick='nextPage(${totalPageshsj})'>尾页</a>
				<#elseif (totalPageshsj=1)> 
