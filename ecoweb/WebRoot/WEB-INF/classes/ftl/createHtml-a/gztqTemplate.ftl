...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos">
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="#">关注团青</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=gztq" method="post" name="Form" id="Form">
		<div class="list_box">	
				<ul>
				 <#list fieldListgztq as var>
