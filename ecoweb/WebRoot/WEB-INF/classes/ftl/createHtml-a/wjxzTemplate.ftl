...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos">
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="#">团学工作</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=tzgg" method="post" name="Form" id="Form">
		<div class="list_box">	
				<ul class="commC">
				...
				<a href="javascript:;"  onclick='nextPage(${totalPagetzgg})'>尾页</a>
				<#elseif (totalPagetzgg=1)> 
