...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos">
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="./qmgc.html">道德讲堂</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=ddjt" method="post" name="Form" id="Form">
		<div class="list_box">	
				<ul class="commC">
				 <#list fieldListddjt as var>
				...
				<a href="javascript:;"  onclick='nextPage(${totalPageddjt})'>尾页</a>
				<#elseif (totalPageddjt=1)> 
				<a href="javascript:;" onclick='nextPage(0)' class="page_home">首页</a>
