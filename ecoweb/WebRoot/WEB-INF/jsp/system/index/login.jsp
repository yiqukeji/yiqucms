...
<html lang="en">
	<head>
		...
		<link href="fh_static_1/imgs/logo/favicon.ico" type="image/x-icon" rel="Shortcut Icon" />
	...
	<body>
		<div class="container logo_img" >
			<img width=""  src="static/login/img/login_logo.png" />
		</div>
		<form action="width:360px;" method="post" name="loginForm" id="loginForm">
		<div class="container">
			<div class="box">
