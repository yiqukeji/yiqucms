...
<div class="content">
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                <li><a href="webprof.html">专业介绍</a></li>
                <li class="ons"><a href="webplan.html">培养方案</a></li>
                <li><a href="webregu.html">规章制度</a></li>
            </ul>
        </div>
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;本科生教育&nbsp;>&nbsp;培养方案</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagepyfa},
        totalSize: ${totalResultpyfa},
        callback: function (num) {
            ajaxTest(${currentPagepyfa});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'pyfa',currentPage:num},
            dataType: "json",
