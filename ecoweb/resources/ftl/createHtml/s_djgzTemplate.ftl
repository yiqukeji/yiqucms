    ...
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                ...
                <li  class="ons"><a href="webdjgz_s.html">学生社团</a></li>
            </ul>
        </div>
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;学生工作&nbsp;>&nbsp;学生社团</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagedjzx_s},
        totalSize: ${totalResultdjzx_s},
        callback: function (num) {
            ajaxTest(${currentPagedjzx_s});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'djzx_s',currentPage:num},
            dataType: "json",
