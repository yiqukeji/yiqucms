    ...
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                ...
                <li class="ons"><a href="webxkjs.html">学科建设</a></li>
                <li><a href="webkydt.html">科研动态</a></li>
            </ul>
        </div>
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>>科学研究 > 学科建设</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagejx},
        totalSize: ${totalResultjx},
        callback: function (num) {
            ajaxTest(${currentPagejx});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'jx',currentPage:num},
            dataType: "json",
