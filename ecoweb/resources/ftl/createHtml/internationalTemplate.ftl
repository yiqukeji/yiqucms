    ...
    <div class="center-1200">
        <div class="cont-menu">
            ...
            <ul>
                ...
                <li class="ons"><a href="webinternation.html">国际交流</a></li>
                <li><a href="webacademic.html">学术交流</a></li>
            </ul>
        </div>
        <div class="cont-right">
            <div class="location">
                <p>你的位置:&nbsp;<a href="index.html">首页</a>&nbsp;>&nbsp;学术研究&nbsp;>&nbsp;国际交流</p>
            </div>
            <div class="list">
                <ul class="list-ul">
                </ul>
...
<script>
    ...
    $("#page").paging({
        pageNo: 10,
        totalPage:${totalPagegjjl},
        totalSize: ${totalResultgjjl},
        callback: function (num) {
            ajaxTest(${currentPagegjjl});
        }
    })
    ...
    function ajaxTest(num) {
        $.ajax({
            url: "web/pageHtml.do",
            type: "get",
            data: {PUB_TYPE:'gjjl',currentPage:num},
            dataType: "json",
