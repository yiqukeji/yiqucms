...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos">
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="./webqmgc.html">青马工程</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=qmgc" method="post" name="Form" id="Form">
		<div class="list_box ">	
				<ul class="commC">
				 <#list fieldListqmgc as var>
				...
				<a href="javascript:;"  onclick='nextPage(${totalPageqmgc})'>尾页</a>
				<#elseif (totalPageqmgc=1)> 
