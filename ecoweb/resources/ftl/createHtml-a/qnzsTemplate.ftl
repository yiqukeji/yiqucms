...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos">
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="./qmgc.html">青年之声</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=qnzs" method="post" name="Form" id="Form">
		<div class="list_box">	
				<ul class="commC">
				 <#list fieldListqnzs as var>
				...
				<a href="javascript:;"  onclick='nextPage(${totalPageqnzs})'>尾页</a>
				<#elseif (totalPageqnzs=1)> 
