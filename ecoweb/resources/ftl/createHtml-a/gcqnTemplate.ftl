...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos">
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="./qmgc.html">贵财青年</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=gcqn" method="post" name="Form" id="Form">
		<div class="list_box">	
				<ul class="commC">
				 <#list fieldListgcqn as var>
				...
				<a href="javascript:;"  onclick='nextPage(${totalPagegcqn})'>尾页</a>
				<#elseif (totalPagegcqn=1)> 
