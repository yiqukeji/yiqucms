...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos">
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="./qmgc.html">精品活动</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=jphd" method="post" name="Form" id="Form">
		<div class="list_box">	
				<ul class="commC">
				 <#list fieldListjphd as var>
				...
				<a href="javascript:;"  onclick='nextPage(${totalPagejphd})'>尾页</a>
				<#elseif (totalPagejphd=1)> 
				<a href="javascript:;" onclick='nextPage(0)' class="page_home">首页</a>
