...
<body>
	...
	<div class="content_warp">
		...
		<div class="current_pos">
			<p>当前位置：<a href="./index.html">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="">学习专栏</a></p>
		</div>
		<form action="web/pageHtml.do?PUB_TYPE=wstx" method="post" name="Form" id="Form">
		<div class="list_box">	
				<ul class="commC">
				 <#list fieldListwstx as var>
				...
				<a href="javascript:;"  onclick='nextPage(${totalPagewstx})'>尾页</a>
				<#elseif (totalPagewstx=1)> 
				<a href="javascript:;" onclick='nextPage(0)' class="page_home">首页</a>
